...
const PlantDetail: React.FC<PlantDetailProps> = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row bg-gray-50 min-h-screen dark:bg-neutral-900">
      ...
      <div className="flex-1 flex flex-col py-5 justify-center items-center mt-25 w-full h-auto">
        <div className="mb-5 pl-25 self-start">
          <h1 className="font-playfair text-3xl font-bold text-emerald-900 mb-1 leading-tight">
            {plant.name}
          </h1>
        ...
        <button
          ...
          className="w-150 py-1 mt-2 bg-emerald-900 rounded-4xl text-white font-inter text-lg font-semibold cursor-pointer transition-colors duration-200 hover:bg-teal-700"
        >
          Edit Plant
        </button>
      </div>
      ...
      <div
        className="flex-1 opacity-100 dark:opacity-70"
        style={{
