    ...
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-900 text-white overflow-hidden">
      ...
      <div className="relative bg-emerald-900/40 border border-emerald-500/30 rounded-xl shadow-xl backdrop-blur-sm p-6 md:p-8 text-center max-w-2xl overflow-hidden">
        ...
        <div className="space-y-4">
          ...
          <h1 className="relative text-3xl md:text-4xl font-extrabold text-green-100 tracking-wide">
          ...
          <p className="text-lg md:text-xl mt-2 text-green-50">
        ...
        <button
          onClick={() => navigate("/")}
          className="mt-6 px-8 md:px-10 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-all duration-300 font-semibold text-lg relative overflow-hidden shadow-lg shadow-yellow-400/20 border border-green-300"
        >
