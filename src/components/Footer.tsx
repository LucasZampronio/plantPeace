import logo from "../images/logoiconwhite.svg"
    ...
    <section className="h-[422px] font-[Inter] font-normal text-sm bg-emerald-900 text-white flex flex-col p-20 gap-12 bg-[url(src/images/backgroundfooter.svg)]">
        <div className="flex place-content-between">
            <div className="flex flex-col gap-4">
                <h1 className="font-[Playfair_Display] font-bold text-[40px]">Stay Fresh</h1>
            ...
            <div className="flex gap-24">
                <nav>
                    <ul  className="flex flex-col gap-4">
                        ...
                        <li className="hover:underline transition"><a href="#">About us</a></li>
                    </ul>
                </nav>
                <nav>
                    <ul  className="flex flex-col gap-4">
