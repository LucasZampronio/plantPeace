  ...
  return (
    <div className="relative">
      <input
        ...
        className={`w-[936px] h-[43px] absolute top-[123px] left-[268px] p-[12px_0_0_0] gap-2 rounded-tl-lg rounded-bl-lg bg-[#F1F5F9] border ${borderColor}`}
      ...
      {query && !borderColor.includes('green') && (
        <div className="absolute w-full left-[268px] mt-2 p-4 bg-white rounded-lg border border-gray-200">
