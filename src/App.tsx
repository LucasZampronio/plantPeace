...
const App: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className=" relative top-[194px] left-[268px] gap-10 w-[1119px] h-auto flex flex-col">
        <div className="flex justify-between">
          {['Card 1', 'Card 2', 'Card 3'].filter(item => !searchResult || item.toLowerCase().includes(searchResult.toLowerCase())).map((item) => (
            <div key={item} className="w-[318px] h-[387.73px] flex flex-col">
              <img
                src="./images/defautplant.png"
                alt={item}
                className="w-[318px] h-[317.18px] opacity-0.9"
              />
              <div
                className=" absolute w-auto h-[38.85px] p-[6.48px_12.95px] gap-[8.09px] rounded-tl-[19.43px] border-[1.62px] border-solid border-[#ECFDF5] bg-[#D1FAE5]"
